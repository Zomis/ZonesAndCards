...
public class MageCards implements CardSet<HStoneGame> {
	...
	public void addCards(HStoneGame game) {
		...
		game.addCard(minion( 2,    COMMON, 3, 2, "Sorcerer's Apprentice").staticMana(isSpell().and(samePlayer()), -1).card());
...
//		game.addCard(minion( 3,      RARE, 4, 3, "Kirin Tor Mage").effect("<b>Battlecry:</b>").effect("The next").effect("<b>Secret</b>").effect("you play this turn costs (0)").card());
		...
		game.addCard(spell( 1,      FREE, "Arcane Missiles").effect(repeat(fixed(3), toRandom(opponent().and(canTakeDamage(1)), damage(1)))).card());
